...
export const municipalities: Municipality[] = [
  ...
  },
  {
    ...
    places: [
      ...
      {
        id: "cuy-2",
        name: "Argamosa Resort",
        description: "A charming resort in Cuyapo offering a relaxing getaway with swimming pools and lush gardens, perfect for family weekends and group outings.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/HOTEL AND RESORT/argamosa/argamosa.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/HOTEL AND RESORT/argamosa/argamosa.jpg'),
        ],
        category: "fun",
        coordinates: { latitude: 15.7840, longitude: 120.6670 },
      },
      {
        id: "cuy-3",
        name: "Armando's Garden Resort Corp",
        description: "A well-known garden resort in Cuyapo featuring beautiful landscaped grounds, swimming pools, and event facilities for memorable celebrations.",
        ...
        category: "fun",
        coordinates: { latitude: 15.7855, longitude: 120.6690 },
      },
      {
        id: "cuy-4",
        name: "Aurora's Resort",
        description: "A cozy resort destination in Cuyapo with refreshing pools and comfortable accommodations, ideal for a peaceful retreat from the city.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/HOTEL AND RESORT/Aurora_s Resort/Aurora_s Resort.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/HOTEL AND RESORT/Aurora_s Resort/Aurora_s Resort.jpg'),
        ],
        category: "fun",
        coordinates: { latitude: 15.7830, longitude: 120.6660 },
      },
      {
        id: "cuy-5",
        name: "Dela Pena Farm Adventure & Spring Resort",
        description: "An exciting farm adventure and spring resort offering outdoor activities, natural spring pools, and a unique agri-tourism experience in Cuyapo.",
        ...
        category: "fun",
        coordinates: { latitude: 15.7860, longitude: 120.6700 },
      },
      {
        id: "cuy-6",
        name: "Padaba Resort",
        description: "A popular local resort in Cuyapo with inviting pools and a relaxed atmosphere, great for day trips and family gatherings.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/HOTEL AND RESORT/padaba resort/padaba resort.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/HOTEL AND RESORT/padaba resort/padaba resort.jpg'),
        ],
        category: "fun",
        coordinates: { latitude: 15.7845, longitude: 120.6675 },
      },
      {
        id: "cuy-7",
        name: "Rancho Hidalgo",
        description: "A ranch-style resort in Cuyapo offering a rustic countryside experience with horseback riding, swimming, and nature activities.",
        ...
        category: "fun",
        coordinates: { latitude: 15.7865, longitude: 120.6695 },
      },
      {
        id: "cuy-8",
        name: "Ynah's Place & Resort",
        description: "A welcoming resort in Cuyapo with modern amenities, clean pools, and comfortable spaces for relaxation and celebrations.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/HOTEL AND RESORT/Ynah_s Place & Resort/Ynah_s Place & Resort.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/HOTEL AND RESORT/Ynah_s Place & Resort/Ynah_s Place & Resort.jpg'),
        ],
        category: "fun",
        coordinates: { latitude: 15.7835, longitude: 120.6665 },
      },
      {
        id: "cuy-9",
        name: "6th Avenue Food Park",
        description: "A vibrant food park in Cuyapo bringing together a variety of food stalls and vendors, offering everything from grilled dishes to refreshing drinks.",
        ...
        category: "food",
        coordinates: { latitude: 15.7842, longitude: 120.6672 },
      },
      {
        id: "cuy-10",
        name: "Armandos Resto and Garden Resort",
        description: "A dual-purpose destination combining a restaurant with a garden resort, serving delicious Filipino cuisine in a beautiful outdoor setting.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Armandos Resto and Garden Resort/Armandos Resto and Garden Resort_.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Armandos Resto and Garden Resort/Armandos Resto and Garden Resort_.jpg'),
        ],
        category: "food",
        coordinates: { latitude: 15.7858, longitude: 120.6692 },
      },
      {
        id: "cuy-11",
        name: "Big MAMA Garden & Cafe",
        description: "A charming garden cafe in Cuyapo known for its cozy ambiance, freshly brewed coffee, and homestyle Filipino dishes.",
        ...
        category: "food",
        coordinates: { latitude: 15.7848, longitude: 120.6678 },
      },
      {
        id: "cuy-12",
        name: "Kape Puno",
        description: "A trendy coffee shop in Cuyapo serving specialty coffee, pastries, and light meals in a modern, Instagram-worthy setting.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Kape Puno/Kape Puno.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Kape Puno/Kape Puno.jpg'),
        ],
        category: "food",
        coordinates: { latitude: 15.7838, longitude: 120.6668 },
      },
      {
        id: "cuy-13",
        name: "Mercedes S. Del Rosario Food Corner",
        description: "A beloved local food corner in Cuyapo offering affordable and delicious Filipino comfort food that keeps locals coming back.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/MERCEDES S. DEL ROSARIO FOOD CORNER/MERCEDES S. DEL ROSARIO FOOD CORNER.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/MERCEDES S. DEL ROSARIO FOOD CORNER/MERCEDES S. DEL ROSARIO FOOD CORNER.jpg'),
        ],
        category: "food",
        coordinates: { latitude: 15.7852, longitude: 120.6685 },
      },
      {
        id: "cuy-14",
        name: "Nook by Armandos",
        description: "A cozy dining nook by the Armandos brand, offering an intimate restaurant experience with curated dishes and a relaxed vibe.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Nook by Armandos/Nook by Armandos_.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Nook by Armandos/Nook by Armandos_.jpg'),
        ],
        category: "food",
        coordinates: { latitude: 15.7856, longitude: 120.6688 },
      },
      {
        id: "cuy-15",
        name: "Tagpuan Restaurant",
        description: "A popular Filipino restaurant in Cuyapo known for its hearty meals, generous portions, and warm hospitality that feels like home.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Tagpuan Restaurant/Tagpuan Restaurant.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Tagpuan Restaurant/Tagpuan Restaurant.jpg'),
        ],
        category: "food",
        coordinates: { latitude: 15.7844, longitude: 120.6674 },
      },
      {
        id: "cuy-16",
        name: "Toylings Restaurant",
        description: "A family-friendly restaurant in Cuyapo serving a wide variety of Filipino dishes in a fun and welcoming atmosphere.",
        image: require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Toylings Restaurant/Toylings Restaurant.jpg'),
        images: [
          require('@/assets/images/Municipal-Images/Cuyapo/RESTAURANT/Toylings Restaurant/Toylings Restaurant.jpg'),
        ],
        category: "food",
        coordinates: { latitude: 15.7850, longitude: 120.6682 },
      },
    ],
  },
  {
